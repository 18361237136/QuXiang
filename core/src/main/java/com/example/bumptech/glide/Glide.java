package com.example.bumptech.glide;
...
import com.example.bumptech.glide.load.engine.Engine;
import com.example.bumptech.glide.load.engine.bitmap_recycle.BitmapPool;
import com.example.bumptech.glide.load.engine.cache.DiskCache;
import com.example.bumptech.glide.load.engine.cache.DiskLruCacheFactory;
import com.example.bumptech.glide.load.engine.cache.MemoryCache;
import com.example.bumptech.glide.load.engine.prefill.BitmapPreFiller;
import com.example.bumptech.glide.load.engine.prefill.PreFillType;
...
import com.example.bumptech.glide.load.model.file_descriptor.FileDescriptorFileLoader;
import com.example.bumptech.glide.load.model.file_descriptor.FileDescriptorResourceLoader;
import com.example.bumptech.glide.load.model.file_descriptor.FileDescriptorStringLoader;
import com.example.bumptech.glide.load.model.file_descriptor.FileDescriptorUriLoader;
import com.example.bumptech.glide.load.model.stream.HttpUrlGlideUrlLoader;
import com.example.bumptech.glide.load.model.stream.StreamByteArrayLoader;
import com.example.bumptech.glide.load.model.stream.StreamFileLoader;
import com.example.bumptech.glide.load.model.stream.StreamResourceLoader;
import com.example.bumptech.glide.load.model.stream.StreamStringLoader;
import com.example.bumptech.glide.load.model.stream.StreamUriLoader;
import com.example.bumptech.glide.load.model.stream.StreamUrlLoader;
import com.example.bumptech.glide.load.resource.bitmap.CenterCrop;
import com.example.bumptech.glide.load.resource.bitmap.FileDescriptorBitmapDataLoadProvider;
import com.example.bumptech.glide.load.resource.bitmap.FitCenter;
import com.example.bumptech.glide.load.resource.bitmap.GlideBitmapDrawable;
import com.example.bumptech.glide.load.resource.bitmap.ImageVideoDataLoadProvider;
import com.example.bumptech.glide.load.resource.bitmap.StreamBitmapDataLoadProvider;
import com.example.bumptech.glide.load.resource.drawable.GlideDrawable;
import com.example.bumptech.glide.load.resource.file.StreamFileDataLoadProvider;
import com.example.bumptech.glide.load.resource.gif.GifDrawable;
import com.example.bumptech.glide.load.resource.gif.GifDrawableLoadProvider;
import com.example.bumptech.glide.load.resource.gifbitmap.GifBitmapWrapper;
import com.example.bumptech.glide.load.resource.gifbitmap.GifBitmapWrapperTransformation;
import com.example.bumptech.glide.load.resource.gifbitmap.ImageVideoGifDrawableLoadProvider;
import com.example.bumptech.glide.load.resource.transcode.GifBitmapWrapperDrawableTranscoder;
import com.example.bumptech.glide.load.resource.transcode.GlideBitmapDrawableTranscoder;
import com.example.bumptech.glide.load.resource.transcode.ResourceTranscoder;
import com.example.bumptech.glide.load.resource.transcode.TranscoderRegistry;
import com.example.bumptech.glide.manager.RequestManagerRetriever;
import com.example.bumptech.glide.module.GlideModule;
import com.example.bumptech.glide.module.ManifestParser;
import com.example.bumptech.glide.provider.DataLoadProvider;
import com.example.bumptech.glide.provider.DataLoadProviderRegistry;
import com.example.bumptech.glide.request.FutureTarget;
import com.example.bumptech.glide.request.Request;
import com.example.bumptech.glide.request.animation.GlideAnimation;
import com.example.bumptech.glide.request.target.ImageViewTargetFactory;
import com.example.bumptech.glide.request.target.Target;
import com.example.bumptech.glide.request.target.ViewTarget;
