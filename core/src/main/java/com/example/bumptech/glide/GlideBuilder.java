...
import com.example.bumptech.glide.load.engine.bitmap_recycle.BitmapPoolAdapter;
import com.example.bumptech.glide.load.engine.bitmap_recycle.LruBitmapPool;
import com.example.bumptech.glide.load.engine.cache.DiskCache;
import com.example.bumptech.glide.load.engine.cache.ExternalCacheDiskCacheFactory;
import com.example.bumptech.glide.load.engine.cache.InternalCacheDiskCacheFactory;
import com.example.bumptech.glide.load.engine.cache.LruResourceCache;
import com.example.bumptech.glide.load.engine.cache.MemoryCache;
import com.example.bumptech.glide.load.engine.cache.MemorySizeCalculator;
import com.example.bumptech.glide.load.engine.executor.FifoPriorityThreadPoolExecutor;
