...
import com.example.bumptech.glide.load.MultiTransformation;
...
import com.example.bumptech.glide.load.resource.UnitTransformation;
import com.example.bumptech.glide.load.resource.transcode.ResourceTranscoder;
import com.example.bumptech.glide.manager.Lifecycle;
import com.example.bumptech.glide.manager.RequestTracker;
import com.example.bumptech.glide.provider.ChildLoadProvider;
import com.example.bumptech.glide.provider.LoadProvider;
import com.example.bumptech.glide.request.FutureTarget;
import com.example.bumptech.glide.request.GenericRequest;
import com.example.bumptech.glide.request.Request;
import com.example.bumptech.glide.request.RequestCoordinator;
import com.example.bumptech.glide.request.RequestFutureTarget;
import com.example.bumptech.glide.request.RequestListener;
import com.example.bumptech.glide.request.ThumbnailRequestCoordinator;
import com.example.bumptech.glide.request.animation.GlideAnimationFactory;
import com.example.bumptech.glide.request.animation.NoAnimation;
import com.example.bumptech.glide.request.animation.ViewAnimationFactory;
import com.example.bumptech.glide.request.animation.ViewPropertyAnimation;
import com.example.bumptech.glide.request.animation.ViewPropertyAnimationFactory;
import com.example.bumptech.glide.request.target.PreloadTarget;
import com.example.bumptech.glide.request.target.Target;
import com.example.bumptech.glide.signature.EmptySignature;
